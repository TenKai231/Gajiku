...
<div class="d-flex justify-content-between align-items-center mb-4 no-print">
    ...
    <div>
        <a href="/?action=laporan/export_excel&bulan=<?= $bulan ?>&tahun=<?= $tahun ?>" class="btn btn-success me-2">
            <i class="bi bi-file-earmark-excel me-1"></i> Export Excel
        </a>
        <a href="/?page=laporan/print&bulan=<?= $bulan ?>&tahun=<?= $tahun ?>" target="_blank" class="btn btn-primary">
            <i class="bi bi-printer me-1"></i> Cetak / PDF Laporan
        </a>
    </div>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        ...
        <div class="text-center mb-4 pb-3 border-bottom">
            ...
            <h5 class="mb-2">Kantor Jaya Bersama</h5>
