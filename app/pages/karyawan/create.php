...
if ($user['role'] !== 'ADMIN') {
    ...
    die('Akses ditolak. Hanya ADMIN yang dapat menambah karyawan.');
}
...
$form = $_SESSION['form'] ?? [
    ...
    'tanggal_lahir' => '', 'tanggal_masuk' => date('Y-m-d'),
    'jabatan_id' => '', 'golongan_id' => '', 'status' => 'Aktif'
];
    ...
    <div class="col-lg-8">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <form action="/?action=karyawan/store" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select <?= isset($errors['golongan_id']) ? 'is-invalid' : '' ?>"
                                    id="golongan_id" name="golongan_id" required>
                                <option value="">-- Pilih Golongan --</option>
                                <?php foreach ($golongans as $g): ?>
                                    <option value="<?= $g['id'] ?>" <?= ((string) $form['golongan_id'] === (string) $g['id']) ? 'selected' : '' ?>>
                                        <?= htmlspecialchars($g['nama_golongan'], ENT_QUOTES, 'UTF-8') ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                            <?php if (isset($errors['golongan_id'])): ?>
                                <div class="invalid-feedback"><?= htmlspecialchars($errors['golongan_id'], ENT_QUOTES, 'UTF-8') ?></div>
                            <?php endif; ?>
                        </div>
